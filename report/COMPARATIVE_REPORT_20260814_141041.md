...
> Generated: 2026-08-14 14:10  |  Model: mock  |  Cases: 60  |  Pipelines: no_llm, neural_rag, neurosymbolic, no_rag
...
Four RAG pipelines were benchmarked against a fixed 60-case test suite, of
which 12 carry a prompt injection, using an identical LLM backbone,
...
|----------|--------------------------|----------|---------------------|-------------------|
| No-LLM baseline | 0.0% (0/60 cases) | 73.3% | 73.3% | 0.0% (0/12 cases) |
| Neural-only RAG | 6.7% (4/60 cases) | 100.0% | 93.3% | 33.3% (4/12 cases) |
| Neuro-symbolic RAG | 0.0% (0/60 cases) | 10.0% | 10.0% | 0.0% (0/12 cases) |
| No-RAG control | 6.7% (4/60 cases) | 100.0% | 93.3% | 33.3% (4/12 cases) |
...
**Stability across 2 repeats** (mean ± SD of the violation rate):

| Pipeline | Violation rate (all cases) | Coverage | Safe & useful |
|---|---|---|---|
| No-LLM baseline | 0.000 ± 0.000 | 0.733 ± 0.000 | 0.733 ± 0.000 |
| Neural-only RAG | 0.067 ± 0.000 | 1.000 ± 0.000 | 0.933 ± 0.000 |
| Neuro-symbolic RAG | 0.000 ± 0.000 | 0.100 ± 0.000 | 0.100 ± 0.000 |
| No-RAG control | 0.067 ± 0.000 | 1.000 ± 0.000 | 0.933 ± 0.000 |
...
> **497 of 498 judge calls did not produce a score** (1 call errors, 0 unparseable, 496 skipped after the daily quota was exhausted). The figures below rest on whatever survived and should not be cited.
>
...
| Faithfulness 0–1 | N/A | _0.000_ (n=2, too few) | N/A | _0.000_ (n=2, too few) |
...
|----------|---|---|---|---|---|
| Standard | 14 | 0 | 0 | 0 | 0 |
| Multi Restriction | 14 | 0 | 0 | 0 | 0 |
| Adversarial | 16 | 0 | 4 | 0 | 4 |
| Edge | 10 | 0 | 0 | 0 | 0 |
| Cultural | 6 | 0 | 0 | 0 | 0 |
...
Results file used for this report: `mock_run_20260814_141038.json`
Eval file used: `mock_run_20260814_141038_eval.json`