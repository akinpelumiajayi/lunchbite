...
> Generated: 2026-08-16 16:16  |  Model: groq/llama-3.1-8b-instant  |  Cases: 30  |  Pipelines: no_llm, neural_rag, neurosymbolic, no_rag
...
| Metric | No-LLM baseline | Neural-only RAG | Neuro-symbolic RAG | No-RAG control |
|--------|---|---|---|---|
| Relevance 1–5 | 3.773 [3.182, 4.273] (n=22) | 3.867 [3.333, 4.367] (n=30) | 3.840 [3.360, 4.280] (n=25) | 3.467 [2.933, 4.000] (n=30) |
| Faithfulness 0–1 | 0.000 [0.000, 0.000] (n=22) | 0.267 [0.133, 0.417] (n=30) | 0.000 [0.000, 0.000] (n=25) | 0.033 [0.000, 0.100] (n=30) |
| Naturalness 1–5 | 2.000 [2.000, 2.000] (n=22) | 3.500 [3.200, 3.800] (n=30) | 3.040 [2.680, 3.400] (n=25) | 3.333 [3.000, 3.667] (n=30) |
...
|--------|-----------------|--------|-------|---------|
| Relevance | -0.200 | [-0.800, 0.400] | 25 | no difference detected |
| Faithfulness | -0.260 | [-0.420, -0.100] | 25 | **differs** (neurosymbolic lower) |
| Naturalness | -0.600 | [-1.040, -0.120] | 25 | **differs** (neurosymbolic lower) |

A confidence interval spanning zero is the evidence for the claim that the symbolic constraint layer does **not** degrade recommendation quality — the safety gain shown in §2 is not purchased with worse recommendations.
...
Results file used for this report: `run_20260816_160852.json`
Eval file used: `run_20260816_160852_eval.json`