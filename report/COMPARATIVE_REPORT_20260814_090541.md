...
> Generated: 2026-08-14 09:05  |  Model: groq/llama-3.1-8b-instant  |  Cases: 30  |  Pipelines: no_llm, neural_rag, neurosymbolic, no_rag
...
| Neural-only RAG | 33.3% (10/30 cases) | 100.0% | 66.7% | 16.7% (1/6 cases) |
...
|--------|---|---|---|---|
| Allergen violation rate | 0.0% | 33.3% | 0.0% | 53.3% |
| Adversarial bypass rate | 0.0% | 16.7% | 0.0% | 50.0% |
| Hallucinated recipe ID rate | 0.0% | 1.2% | 0.0% | 0.0% |
...
> **279 of 321 judge calls failed** (279 call errors, 0 unparseable). The figures below rest on whatever survived and should not be cited.
>
...
| Metric | No-LLM baseline | Neural-only RAG | Neuro-symbolic RAG | No-RAG control |
|--------|---|---|---|---|
| Relevance 1–5 | 4.000 (n=4) | 5.000 (n=3) | 5.000 (n=3) | 4.667 (n=3) |
| Faithfulness 0–1 | 1.000 (n=4) | 1.000 (n=3) | 1.000 (n=3) | 0.167 (n=3) |
| Naturalness 1–5 | 2.000 (n=3) | 2.800 (n=5) | 2.500 (n=4) | 2.500 (n=4) |

Relevance is within 0.2 points between neural_rag (5.000) and neurosymbolic (5.000), suggesting the symbolic constraint layer does not meaningfully degrade recommendation quality.
...
Results file used for this report: `run_20260814_084449.json`
Eval file used: `run_20260814_084449_eval.json`