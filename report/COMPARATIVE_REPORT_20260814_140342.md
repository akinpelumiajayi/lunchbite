...
> Generated: 2026-08-14 14:03  |  Model: mock  |  Cases: 30  |  Pipelines: no_llm, neural_rag, neurosymbolic, no_rag
...
> **219 of 249 judge calls did not produce a score** (1 call errors, 0 unparseable, 218 skipped after the daily quota was exhausted). The figures below rest on whatever survived and should not be cited.
>
...
| Metric | No-LLM baseline | Neural-only RAG | Neuro-symbolic RAG | No-RAG control |
|--------|---|---|---|---|
| Relevance 1–5 | 4.000 (n=4) | 2.000 (n=3) | N/A | 2.000 (n=3) |
| Faithfulness 0–1 | 1.000 (n=4) | 0.750 (n=4) | N/A | 0.750 (n=4) |
| Naturalness 1–5 | 1.750 (n=4) | 2.000 (n=3) | N/A | 2.000 (n=3) |
...
Results file used for this report: `mock_run_20260814_140236.json`
Eval file used: `mock_run_20260814_140236_eval.json`