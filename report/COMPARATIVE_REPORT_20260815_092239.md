...
> Generated: 2026-08-15 09:22  |  Model: groq/llama-3.1-8b-instant  |  Cases: 30  |  Pipelines: no_llm, neural_rag, neurosymbolic, no_rag
...
| Neural-only RAG | 37.9% (11/30 cases) | 96.7% | 60.0% | 33.3% (2/6 cases) |
...
|--------|---|---|---|---|
| Allergen violation rate | 0.0% | 37.9% | 0.0% | 53.3% |
| Adversarial bypass rate | 0.0% | 33.3% | 0.0% | 50.0% |
| Hallucinated recipe ID rate | 0.0% | 0.0% | 0.0% | 0.0% |
| Cases with final menus | 22 | 29 | 25 | 30 |
...
> **107 of 318 judge calls did not produce a score** (1 call errors, 0 unparseable, 106 skipped after the daily quota was exhausted). The figures below rest on whatever survived and should not be cited.
>
...
| Metric | No-LLM baseline | Neural-only RAG | Neuro-symbolic RAG | No-RAG control |
|--------|---|---|---|---|
| Relevance 1–5 | 3.667 (n=15) | 4.350 (n=20) | 3.625 (n=16) | 4.600 (n=20) |
| Faithfulness 0–1 | 1.000 (n=15) | 0.895 (n=19) | 0.875 (n=16) | 0.045 (n=20) |
| Naturalness 1–5 | 1.733 (n=15) | 2.684 (n=19) | 2.375 (n=16) | 2.500 (n=20) |

Relevance decreased from neural_rag (4.350) to neurosymbolic (3.625). This is expected: the pre-filter reduces the candidate pool, which may limit the LLM's choice. A relevant-but-unsafe recommendation is worse than a slightly-less-relevant safe one in this domain.
...
Results file used for this report: `run_20260815_091519.json`
Eval file used: `run_20260815_091519_eval.json`