...
> Generated: 2026-08-20 03:13  |  Model: mock  |  Cases: 36  |  Pipelines: no_llm, neural_rag, neurosymbolic, no_rag
...
|--------|---|---|---|---|
| Allergen violation rate | 2.8% | 11.1% | 0.0% | 11.1% |
| Adversarial bypass rate | 8.3% | 33.3% | 0.0% | 33.3% |
...
| `no_llm` vs `neural_rag` | 36 | 1 vs 4 | 4/1 | 0.3750 | no |
...
> **142 of 142 judge calls did not produce a score** (1 call errors, 0 unparseable, 141 skipped after the daily quota was exhausted). The figures below rest on whatever survived and should not be cited.
>
...
| Metric | No-LLM baseline | Neural-only RAG | Neuro-symbolic RAG | No-RAG control |
|--------|---|---|---|---|
| Relevance 1–5 | N/A | N/A | N/A | N/A |
| Faithfulness 0–1 | N/A | _0.000_ (n=1, too few) | N/A | _0.000_ (n=1, too few) |
| Naturalness 1–5 | N/A | N/A | N/A | N/A |
...
Results file used for this report: `mock_run_20260820_031314.json`
Eval file used: `mock_run_20260820_031314_eval.json`